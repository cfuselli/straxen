...
class PeakletsSV(straxen.Peaklets):
    ...
    data_kind = {'peaklets_sv': 'peaklets', 'lone_hits_sv': 'lone_hits'}
...
class PulseProcessingSV(straxen.PulseProcessing):
    ...
    data_kind = {'records_sv': 'records', 'veto_regions_sv': 'veto_regions', 'pulse_counts_sv': 'pulse_counts'}
...
class PulseProcessingHighEnergySV(straxen.PulseProcessingHighEnergy):
    ...
    data_kind = {'records_he_sv': 'records_he', 'pulse_counts_he_sv': 'pulse_counts_he'}
...
class nVETORecorderSV(straxen.nVETORecorder):
    ...
    data_kind = {'raw_records_coin_nv_sv': 'raw_records_coin_nv', 'lone_raw_records_nv_sv': 'lone_raw_records_nv', 'lone_raw_record_statistics_nv_sv': 'lone_raw_record_statistics_nv'}
